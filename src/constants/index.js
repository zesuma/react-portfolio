  ...
  const experiences = [
    {
      ...
      points: [
        "Led front-end development for several key projects, such as Computerworld’s Best Places to Work, Salary Survey and CIO-100",
        "Spearheaded development for custom HTML email templates and Solution Center Marketing Campaigns built with Liquid Ruby code",
        "Maintained and developed new features for the IDG US suite of sites, including Computerworld, Macworld, PC World, and more",
        "Provided front-end development on medium to large-scale projects",
      ],
    },
    {
      title: "WordPress Developer",
      ...
      points: [
        ...
        "Daily security checks and plugin updates.",
    ...
    },
    {
      ...
      points: [
        "Implement responsive design using Flexbox and CSS Grid with semantic HTML and CSS best practices.",
        "Took project from scoping requirements, development, and testing through actual project launch.",
        "Deployed project with GIT source control",
        "Scoped, estimated, communicated and tracked project progress with the project management team.",
        "Built the page templates using Liquid, CSS, and Javascript.",
      ],
    },
    {
